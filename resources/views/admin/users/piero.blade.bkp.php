...
@endif
  ...
  <div class="col-lg-6 col-md-12 col-xs-12 bkgjumbo" style="padding:12px;margin-bottom:20px;" id="nuevoColchon">
	 <div style="margin-bottom:-20px;margin-top: -20px;" class="jumbotron bkgfalse">
  		<h2>Bienvenido</h2>
  		<p style="font-size:18px;margin-right:120px;">
  			Desde aqu&iacute; podr&aacute; registrar la garantia extendida de sus productos adquiridos. Para ello debe indefectiblemente  registrarlos dentro de los primeros 12 meses de realizada la compra y obtendr&aacute;
  			su garant&iacute;a extendida por 5 a&ntilde;os desde la compra de forma gratuita.
  		</p>
  		<a href="#" id="addNuevo" class="agregarNuevo btn btn-primary"><i class="fa fa-plus"></i>&nbsp; Agregar Nueva</a>&nbsp;<a href="#" id="addNuevo" class="agregarNuevo btn btn-primary" data-toggle="modal" data-target="#terminos"><i class="fa fa-gavel"></i>  Terminos y condiciones</a>
	 </div>
	</div>
  ...
  if( $("#cuitEntidad").val() ){
        ...
        $.ajax({
                ...
                success:  function (respuesta) {
                    ...
                    var contenido =  '<div style="padding-left:10px;margin-bottom:10px;" class="verDatos col-xs-12">' +
                                      ...
                                      '<div class="form-group">' +
                                      '<label class="control-label col-xs-3">Fecha Factura:</label>' +
                                      '<div class="col-xs-5">' +
                                        '<div class="input-group">' +
                                      ...
                                      '</div>' +
                                      '<div class="col-xs-4">' +
                                        '<button style="line-height: 3;margin-top: -40px;width: 100%;min-width: 140px;" id="regCompra" class="btn btn-primary" type="button" data-toggle="modal" data-target="#terminos">Registrar compra</button>' +
                                      '</div>' +
                                      '</div>';
                  }else{
