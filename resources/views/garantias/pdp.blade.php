<!-- Modal -->
<div id="PDP" class="modal fade" role="dialog">
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      <div class="modal-header" style="min-height:65px;">
        ...
        <h4 class="modal-title" style="">Política de confidencialidad y Protección de datos personales

        </h4>
      </div>
      <div class="modal-body" style="max-height:400px;overflow-y:auto;">

        <div id="agreementPDP" style="height:100%;">
...
La presente Política se rige por las leyes de la República Argentina. Ante cualquier disputa o reclamo que surja con relación a la misma, incluyendo cualquier disputa sobre la validez, interpretación, exigibilidad o incumplimiento será competente la Justicia Nacional Ordinaria en lo Comercial de la Ciudad Autónoma de Buenos Aires. </br>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default printerPDP" data-dismiss="modal"><i class="fa fa-print" aria-hidden="true"></i> Imprimir</button>
